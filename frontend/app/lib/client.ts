...
export function Environment(name: string): BaseURL {
    return `https://${name}-nac-entropy-z992.encr.app`
}
...
/**
 * Client is an API client for the nac-entropy-z992 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "nac-entropy-z992-Generated-TS-Client (Encore/v1.45.2)";
        }
